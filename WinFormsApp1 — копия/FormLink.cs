...
namespace WinFormsApp1
{
    public partial class FormLink : Form
    {
        ...
        {
            listBox1.DataSource = FormRegistration.instance.starSystems;
            //FormRegistration.instance.starSystems;
            listBox1.DisplayMember = "Name";
            listBox1.ValueMember = "Name";

            this.pictureBox1.DataBindings.Add(new Binding("Image", FormRegistration.instance.starSystems, "Img"));
            this.richTextBox1.DataBindings.Add(new Binding("Text", FormRegistration.instance.starSystems, "StructureInfo"));
        }
